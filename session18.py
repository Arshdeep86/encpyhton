...
while usage == "yes":
    if choice == 1:
        ...
        if save == "yes":
            ...
            #con = mysql.connector.connect(user="root", password="", database="pythonDB", host="127.0.0.1", port="3306")
            con = lib.connect(user="root", password="", database="pythondb", host="127.0.0.1", port="3306")
